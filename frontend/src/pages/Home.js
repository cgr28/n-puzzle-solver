...
export default function Home() {
  ...
  const handleSubmit = (event) => {
    ...
    setLoading(1);
    fetch(
      `http://localhost:4567/api/solve/${initial}/${goal}/${heuristic}/${n}/${solver}`
    )
      .then((res) => res.json())
      .then((data) => {
        setError();
      ...
      <div className="flex flex-row">
        <div className="basis-1/2 grid justify-items-center">
          <div>
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-2">
                <label className="header" htmlFor="n-value">
                  Puzzle Size:
                </label>
                <br />
                <select
              ...
              <div className="mt-2">
                <label className="header" htmlFor="Heuristic">
                  Heuristic:
                </label>
                <br />
                <select
                  ...
                  id="heuristic"
                >
                  <option className="option" value="manhattan">
                    Manhattan Distance
                  </option>
                  <option className="option" value="euclidean">
                    Euclidean Distance
                  </option>
                  {n == "3" && (
                    <option className="option" value="pdb">
                      Pattern Database
                    </option>
                  )}
                </select>
              ...
              <div className="mt-2">
                ...
                <select
                  ...
                  id="heuristic"
                >
                  <option className="option" value="idastar">
                    IDA*
                  </option>
        ...
        <div className="basis-1/2 grid justify-items-center content-start">
          ...
          <ol type="1" className="list-decimal">
            ...
            <li className="text mt-2">
              Enter an initial puzzle numbered 1, 2, 3...n, use a 0 to represent
              the empty space.
            </li>
            <li className="text mt-2">Select a heuristic to use.</li>
            <ol type="a" className="ml-6 list-[lower-alpha]">
              <li className="text mt-2 ml-2">
                <a
                ...
                : Uses the distance from the cell's current position to the goal
                position measured along axes at right angles.
              </li>
              <li className="text mt-2 ml-2">
                <a
                ...
                : Uses the length of a straight line from the cell's current
                position to the goal position.
              </li>
              <li className="text mt-2 ml-2">
                <a
                  href="https://www.cs.cmu.edu/afs/cs/project/jair/pub/volume22/felner04b.pdf"
                  className="link"
                >
                  Pattern Database (8-Puzzle only)
                </a>
                : Best heuristic, uses the most memory.
              </li>
            </ol>
            ...
            <ol type="a" className="ml-6 list-[lower-alpha]">
              <li className="text mt-2 ml-2">
                ...
                : Finds the optimal solution. Utilizes a heuristic like A*, but
                has lower memory usage because of it's usage of depth-first
                search
              </li>
              <li className="text mt-2 ml-2">
                <a
                ...
                : Finds the optimal solution. Uses a node's cost from the start
                node and it's heuristic cost to decide where to search next.
              </li>
              <li className="text mt-2 ml-2">
                <a
                ...
                : Solution not guaranteed to be optimal. Decides where to search
                next by choosing the next node with the lowest heuristic cost.
              </li>
            </ol>
            <li className="text mt-2">
              Enter a goal puzzle numbered 1, 2, 3...n, use a 0 to represent the
              empty space.
            </li>
          </ol>
        </div>
      ...
      <div className="grid justify-items-center mt-16">
        ...
        {steps && (
          <div className="">
            ...
            <div className="mt-4">
              <button className={"btn mr-2 px-1"} onClick={stepBackward}>
                Prev
              </button>
              <button className={"btn px-1"} onClick={stepForward}>
                Next
              </button>
            </div>
          </div>
